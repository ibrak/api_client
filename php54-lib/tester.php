<?php
// this PHP script require curl and json methode
...
// We wrap curl in this simple methode to call iBrak Methode URL
function iBrakAPI_CallMethode($methode, $postData){
	// create curl resource
	$ch = curl_init();
	
	// set url for iBrak API Methode
	// we start with a 'hello' methode
	curl_setopt($ch, CURLOPT_URL, "https://api.ibrak.com/" . $methode);	
	// use post request 
	...
	// $response contain iBrak API Methode response
...
// iBrak API use a json objet to store parameters
$json = array();
